...
2026-09-23 checkpoint: **8d92d2c** completes recorded Search/checkout/confirmation loading with cancellation, resubmission and history behavior. **9917969** aligns tracking actions, parcel artwork and recommendation crops. The complete continuous-flow capture scores **424/424** frames with zero browser/replay errors and **2.543594% mean MAE**; related journeys pass **91 distinct tests**, units **136/136**. Exact source, failures/reruns and limitations are in the [current checkpoint](shop-implementation-map.md#current-source-checkpoint). Continue remaining shared typography/media/motion differences; all 97 flows remain in scope and none is owner accepted. Later **2e73de0** fits photo-answer cards with 22/22 scoped captures, two improved frames, 20 unchanged frames and 24/24 passing photo/answer journeys; the complete ledger remains 9917969.
...
2026-09-23 reference checkpoint: Recorded checkout loading now resolves identity, shipping, recommendations and totals in order before enabling payment; explicit preview confirmation has its captured skeleton-to-content transition. Back/Forward, direct entry and cancellation remain connected. Tracking artwork/actions and source recommendation crops are fitted. Related commerce/Search/Orders journeys pass 91 distinct tests; this does not verify real payment, stock or fulfillment. Remaining reference typography/media/motion work stays in Tasks 3/6; [current evidence](docs/STATUS.md) records exact scope.
...
2026-09-23 checkpoint: the [frame ledger](shop-frame-ledger.md) is regenerated from tracked-clean **9917969** / **20260923-complete-motion-orders**, continuous-flow replay: **424/424** frames, zero replay/browser errors, **77 numerical candidates**, **347 above at least one threshold**. Separate isolated flow 21/26 replay passes 13/13 after fixing timing failures. All **755** frozen source hashes verify; original-media verification still fails three assets and exact motion remains unresolved. Related journeys pass **91 distinct tests**, units **136/136**. No fresh full browser suite, production build or real-service qualification was run. Source approval remains **0/97**. Exact evidence and next work are in the [implementation checkpoint](shop-implementation-map.md#current-source-checkpoint) and [new-session prompt](single-session-execution.md#new-session-prompt).
